            ...
            <div className="container-fluid" style={{ width: '90%' }}>
                ...
                <div className="collapse navbar-collapse" id="navbarResponsive">
                    <ul className="navbar-nav ms-auto fs-5">
                        ...
                        <li className="nav-item mx-0 mx-lg-1">
                            <Link href="https://eu-west-1cqv0ahnls.auth.eu-west-1.amazoncognito.com/signup?client_id=3p7arovt4ql7qasmbjg52u1qas&redirect_uri=https://d245iwoa00k2r.cloudfront.net/login&response_type=code&scope=email+openid+phone" className="register-button nav-link py-3 px-0 px-lg-3 rounded-pill border text-black fs-5 fw-bold">
                                Register
                            </Link>
                        </li>
                        <li className="nav-item mx-0 mx-lg-1">
                            <Link href="https://eu-west-1cqv0ahnls.auth.eu-west-1.amazoncognito.com/login?client_id=3p7arovt4ql7qasmbjg52u1qas&redirect_uri=https://d245iwoa00k2r.cloudfront.net/login&response_type=code&scope=email+openid+phone" className={`nav-link py-3 px-0 px-lg-3 rounded-pill sw-bgcolor text-white fs-5 fw-bold`}>
                                Login
                            </Link>
                        </li>
                    </ul>
